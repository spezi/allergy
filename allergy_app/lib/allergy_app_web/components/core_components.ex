defmodule AllergyAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AllergyAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AllergyAppWeb.Gettext, "errors", msg, opts)
    end
  end
